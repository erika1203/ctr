...
class Stacking(object):
    ...
    def stacking(self):
        ...
        train_name = path + "stacking_train_features.csv"
        test_name = path + "stacking_test_features.csv"
