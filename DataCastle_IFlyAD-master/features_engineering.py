...
class Processing(object):
    ...
    def _get_data(name):
        if name == "train":
            file_name = path + "round1_iflyad_train.txt"
        elif name == "test":
            file_name = path + "round1_iflyad_test_feature.txt"
        else:
    ...
    def get_processing(self):
        ...
        train_name = path + "train_features.csv"
        test_name =  path + "test_features.csv"
...
def binning(q=20):
    ...
    train_name = path + "qcut_train_features.csv"
    test_name = path + "qcut_test_features.csv"
...
def features_selector():
    ...
    train_name = path + "filter_qcut_train_features.csv"
    test_name =  path + "filter_qcut_test_features.csv"
